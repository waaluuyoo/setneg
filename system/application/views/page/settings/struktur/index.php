...
<div class="page">
	<div class="page-header">
      ...
      <div class="page-header-actions">
		<a type="button" class="btn btn-success" href="<?=base_url()?>settings/struktur_organisasi/add/0/1">
          ...
          <div class="panel">
            <div class="panel-body">
              <table class="table table-hover dataTable table-striped w-full">
				...
				<tbody>
					<?php foreach($liststruktur->result_array() as $rows) {
						$this->liststruktur_organisasi->addToArray($rows['struktur_organisasi_id'], $rows['struktur_organisasi_nama'], $rows['parent'], $rows['struktur_organisasi_level'], str_replace(',','-',$rows['struktur_organisasi_mychild']));
					}

					$this->liststruktur_organisasi->drawTree(); ?>
				</tbody>
			  </table>
            </div>
          </div>
