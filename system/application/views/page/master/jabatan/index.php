...
<div class="page">
	<div class="page-header">
      ...
      <div class="page-header-actions">
		<a type="button" class="btn btn-success" href="<?=base_url()?>master/jabatan_pengesah/add">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      table = $('#Tabel').DataTable({ 
		...
		"info":     false,
        "ajax": {
            "url": "<?php echo site_url('datatable/data_jabatanpengesah')?>",
            "type": "POST"
        },
		"columnDefs": [
        { 
