...
foreach($edit->result_array() as $row){
	...
	$pertanyaan = $row['pertanyaan_isi'];
	$status = $row['pertanyaan_status'];
	$act = 'edit_pertanyaan';
}
...
<div class="page">
	<div class="page-header">
      ...
      <div class="page-header-actions">
		<a type="button" class="btn btn-warning" href="<?=base_url()?>master/pertanyaan">
			...
			$("#FrmAjax").on('submit',(function(e) {
				...
				success: function(data)   // A function to be called if request succeeds
				{
					if(data == '1'){
						...
						location.href="<?=base_url()?>master/pertanyaan"
					}else{
						  $('.alert').show();
