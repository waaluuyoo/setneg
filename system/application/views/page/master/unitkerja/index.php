...
<div class="page">
	<div class="page-header">
      ...
      <div class="page-header-actions">
		<a type="button" class="btn btn-success" href="<?=base_url()?>master/unit_kerja/add">
              ...
              <table class="table table-hover dataTable table-striped w-full" id="Tabel">
				<thead>
				  <tr>
					...
					<th width="200" >Nama Satuan Organisasi</th>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      table = $('#Tabel').DataTable({ 
		...
		"info":     false,
        "ajax": {
            "url": "<?php echo site_url('datatable/data_unitkerja')?>",
            "type": "POST"
        },
		"columnDefs": [
        { 
