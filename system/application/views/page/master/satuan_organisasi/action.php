...
$id = '';
$nama = '';
$act = 'add_satuan_organisasi';
foreach($edit->result_array() as $row){
	$id = $row['satuan_organisasi_id'];
	$nama = $row['satuan_organisasi_nama'];
	$act = 'edit_satuan_organisasi';
}
...
<div class="page">
	<div class="page-header">
      ...
      <div class="page-header-actions">
		<a type="button" class="btn btn-warning" href="<?=base_url()?>master/satuan_organisasi">
				...
				<div class="panel-body">
				  ...
				  <input type="hidden" name="id" value="<?=$id?>"/>
					...
					<div class="form-group row">
					  <label class="col-md-3 form-control-label">Nama Satuan Organisasi</label>
					  <div class="col-md-6">
						<input type="text" class="form-control" name="NamaSatker" value="<?=$nama?>"/>
					  </div>
					</div>
			...
			$("#FrmAjax").on('submit',(function(e) {
				...
				success: function(data)   // A function to be called if request succeeds
				{
					if(data == '1'){
						...
						location.href="<?=base_url()?>master/satuan_organisasi"
					}else{
						  $('.alert').show();
