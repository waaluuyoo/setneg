...
<div class="page">
	<div class="page-header">
      ...
      <div class="page-header-actions">
		<a type="button" class="btn btn-warning" href="<?=base_url()?>front/tentang_kami">
			...
			<div class="col-lg-12">
			  ...
			  <div class="panel">
				...
				<div class="panel-body">
				  ...
				  <input type="hidden" name="menu" value="tentang_kami"/>
				...
				$.ajax({
					...
					success: function(data)   // A function to be called if request succeeds
					{
						if(data == '1'){
							...
							location.href="<?=base_url()?>front/tentang_kami"
						}else{
