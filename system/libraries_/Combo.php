...
************************************************************************************************************/	
	...
	*/
	...
	function addToArray($id,$name,$parentID,$level,$edit){
		if(empty($parentID))$parentID=0;	
		$this->elementArray[$parentID][] = array($id,$name,$level,$edit);
	}
	
	
	function drawTree(){
		for($no=0;$no<count($this->elementArray[0]);$no++){
			echo "<option value='".$this->elementArray[0][$no][0]."'>".$this->elementArray[0][$no][1]."";		
	...
	private function drawSubNode($parentID){
		if(isset($this->elementArray[$parentID])){
			...
			for($no=0;$no<count($this->elementArray[$parentID]);$no++){
				...
				if($this->elementArray[$parentID][$no][0] == $this->elementArray[$parentID][$no][3])
					$selected = 'selected';
				
				echo "<option value='".$this->elementArray[$parentID][$no][0]."' ".$selected.">".$tab." ".$this->elementArray[$parentID][$no][1]."";	
